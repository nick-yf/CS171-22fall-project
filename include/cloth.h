...
class RectCloth : public Mesh {
 public:
  ...
  void fixPointByCursor(Vec3 origin, Vec3 dir, Vec3 forward, bool setOrNot);
 ...
 private:
  ...
  [[nodiscard]] Vec3 ComputeWindForce(int iw, int ih, Vec3 wind_speed) const;
